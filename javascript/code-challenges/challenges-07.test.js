...
const sortStarWarsCharacters = (starWarsArr) => {
  ...
  function ascendingSort(firstItem, secondItem) {
    return secondItem.height - firstItem.height;
  }
  let sortByHeight = starWarsArr.sort(ascendingSort);
  return sortByHeight;  
}
...
const removeThree = (idx, arr) => {
  let thingsRemoved = arr.splice(idx, 3);
  return arr;
};
