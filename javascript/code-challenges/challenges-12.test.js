...
const replaceZeros = (string) => {
  ...
  let returnData = string.replace(regex, "zero");
...
// Done with help from Matt Miguel
...
const validatePin = (pin) => {
  ...
  // if (pin.length != 4){
  //   return false;
  // } else if (letterMatch.test(pin)) {
  //   return false;
  // } else if (numMatch.test(pin)){
  //   return true;
  // }
  return numMatch.test(pin);
...
const hasNumber = (string) => {
  ...
  // const matchLetter = /a+[a-zA-Z]/g
  // const matchNumber = /a+[0-9]/g

  // if (matchLetter.test(string)) {
  //   ;
  //   return true;
  // } else {
  //   return false;
